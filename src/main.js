// Main application entry point with all modules
    import('./core/storage.js').catch(() => null),
    import('./core/map.js').catch(() => null),
    import('./core/tracking.js').catch(() => null),
    import('./core/timer.js').catch(() => null),
    import('./features/accessibility.js').catch(() => null),
    import('./features/media.js').catch(() => null),
    import('./features/export.js').catch(() => null),
    import('./features/firebase.js').catch(() => null),
    import('./ui/navigation.js').catch(() => null),
    import('./ui/compass.js').catch(() => null),
    import('./utils/geolocation.js').catch(() => null),
    import('./utils/calculations.js').catch(() => null),
    import('./utils/helpers.js').catch(() => null)
